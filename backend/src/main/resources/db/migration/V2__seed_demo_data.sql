...
-- V2: Seed Realistic Demo Data
-- Fictional dataset for dashboard analytics and presentation
-- ==========================================================

-- 1. Insert Students (15 fictional candidates)
...
-- 2. Insert Companies (6 partner recruiters)
...
-- 3. Insert Jobs (10 job opportunities)
...
-- 4. Insert Applications (20 applications across stages)
...
-- 5. Insert Interviews (10 interviews across evaluation rounds)
